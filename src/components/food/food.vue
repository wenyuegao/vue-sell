      ...
      <div class="food-content">
        ...
        <div class="rating-wrapper">
          <ul v-show="food.ratings && food.ratings.length">
            <li v-show="needShow(rating.rateType, rating.text)" v-for="rating in food.ratings" :key="rating.hash" class="rating-item border-1px">
              <div class="user">
  ...
  .image-header
    ...
    .back
      ...
      .icon_arrow_lift
        ...
        background-image : url("arrow_lift.png")
